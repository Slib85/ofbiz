...
iptables -A INPUT -p tcp -s 10.223.240.122,10.223.241.169 --dport 22 -j ACCEPT
...
## open access to mysql server for webservers and office ##
iptables -A INPUT -p tcp -s 173.251.121.74,10.223.240.122,10.223.241.169,10.211.65.214,10.211.64.42,10.211.66.40 --dport 4406 -j ACCEPT
iptables -A OUTPUT -p tcp -s 173.251.121.74,10.223.240.122,10.223.241.169,10.211.65.214,10.211.64.42,10.211.66.40 --dport 4406 -j ACCEPT
