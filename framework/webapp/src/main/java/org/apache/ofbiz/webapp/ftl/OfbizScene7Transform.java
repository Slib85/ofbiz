...
import org.apache.ofbiz.webapp.taglib.Scene7UrlTag;
...
/**
 * OfbizScene7Transform - Freemarker Transform for s7 links
 */
public class OfbizScene7Transform implements TemplateTransformModel {

    public final static String module = OfbizScene7Transform.class.getName();
    ...
    public Writer getWriter(final Writer out, Map args) {
        ...
        final String imgSize = OfbizScene7Transform.getArg(args, "variant");
        return new Writer(out) {
            ...
            public void close() throws IOException {
                try {
                    ...
                    Scene7UrlTag.appendContentPrefix(request, newURL);
