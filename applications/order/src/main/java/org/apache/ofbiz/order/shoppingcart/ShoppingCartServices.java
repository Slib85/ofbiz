...
public class ShoppingCartServices {
    ...
    public static Map<String, Object>loadCartFromOrder(DispatchContext dctx, Map<String, Object> context) {
        ...
        boolean useOrderPrice = (UtilValidate.isNotEmpty(context.get("useOrderPrice"))) ? Boolean.TRUE.equals(context.get("useOrderPrice")) : false;
        Locale locale = (Locale) context.get("locale");
        ...
        try {
            cart.setUserLogin(EntityQuery.use(delegator).from("UserLogin").where("partyId", placingParty.getString("partyId")).queryFirst(), dispatcher);
        } catch (Exception e) {
            Debug.logError(e, module);
            return ServiceUtil.returnError(e.getMessage());
        }
        ...
        if (UtilValidate.isNotEmpty(orderItems)) {
            for (GenericValue item : orderItems) {
                ...
                if ("Y".equals(item.getString("isModifiedPrice")) || useOrderPrice) {
