...
public class ShoppingCartItem implements java.io.Serializable {
    ...
    public static String[] attributeNames = {
                                                ...
                                                "itemComment",
                                                "fromInventoryItemId",
                                                "envPriceCalcAttributes",
                                                "envPriceResultAttributes",
                                                "envArtworkAttributes",
                                                "envQuoteAttributes",
                                                "envQuantityAttributes"
                                            };
    ...
    /** the product stock related to the product */
    private transient GenericValue _productStock = null;
    ...
    private String rushProduction = null;
    private String artworkSource = null;
    private String referenceOrderId = null;
    private String referenceOrderItemSeqId = null;
    private String referenceQuoteId = null;
    private String referenceQuoteItemSeqId = null;
    ...
    */
    ...
    public ShoppingCartItem(ShoppingCartItem item) {
        ...
        this.setRushProduction(item.getRushProduction());
        this.setArtworkSource(item.getArtworkSource());
        this.setReferenceOrderId(item.getReferenceOrderId());
        this.setReferenceOrderItemSeqId(item.getReferenceOrderItemSeqId());
        this.setReferenceQuoteId(item.getReferenceQuoteId());
        this.setReferenceQuoteItemSeqId(item.getReferenceQuoteItemSeqId());
        ...
        if (_product != null && isModifiedPrice == false) {
            try {
                ...
                if (cart.getOrderType().equals("PURCHASE_ORDER")) {
                    ...
                    //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                    //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                    //THIS IS THE ITEM ATTRIBUTES TO PASS TO THE ShoppingCartItem
                    // check for artwork details
                    Map<String, Object> envPriceCalcAttributes = (Map<String, Object>) this.getAttribute("envPriceCalcAttributes");
                    if(UtilValidate.isNotEmpty(envPriceCalcAttributes)) {
                        for(Map.Entry<String, Object> priceParam : envPriceCalcAttributes.entrySet()) {
                            priceContext.put((String)priceParam.getKey(), priceParam.getValue());
                        }
                    }
                    //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                    //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
                    ...
                    this.setAttribute("envPriceResultAttributes", priceResult.get("envPriceResultAttributes"));
                    this.orderItemPriceInfos = UtilGenerics.checkList(priceResult.get("orderItemPriceInfos"));
    ...
    public boolean isCustomQuantity() {
        return isCustomQuantity;
    }

    public void setCustomQuantity(boolean isCustomQuantity) {
        this.isCustomQuantity = isCustomQuantity;
    }
    ...
    public void setRushProduction(String rushProduction) {
        //Debug.logInfo("Setting rushProduction - " + rushProduction, module);
        this.rushProduction = rushProduction;
    }

    public String getRushProduction() {
        return rushProduction;
    }

    public void setArtworkSource(String artworkSource) {
        //Debug.logInfo("Setting artworkSource - " + artworkSource, module);
        this.artworkSource = artworkSource;
    }

    public String getArtworkSource() {
        return artworkSource;
    }

    public void setReferenceOrderId(String referenceOrderId) {
        //Debug.logInfo("Setting referenceOrderId - " + referenceOrderId, module);
    ...
    public void setReferenceOrderItemSeqId(String referenceOrderItemSeqId) {
        //Debug.logInfo("Setting referenceOrderItemSeqId - " + referenceOrderItemSeqId, module);
        this.referenceOrderItemSeqId = referenceOrderItemSeqId;
    }

    public String getReferenceOrderItemSeqId() {
        return referenceOrderItemSeqId;
    }

    public void setReferenceQuoteId(String referenceQuoteId) {
        //Debug.logInfo("Setting referenceOrderId - " + referenceQuoteId, module);
        this.referenceQuoteId = referenceQuoteId;
    }

    public String getReferenceQuoteId() {
        return referenceQuoteId;
    }

    public void setReferenceQuoteItemSeqId(String referenceQuoteItemSeqId) {
        //Debug.logInfo("Setting referenceQuoteItemSeqId - " + referenceQuoteItemSeqId, module);
        this.referenceQuoteItemSeqId = referenceQuoteItemSeqId;
    }

    public String getReferenceQuoteItemSeqId() {
        return referenceQuoteItemSeqId;
    }
    ...
    **/
    ...
    public String getName(LocalDispatcher dispatcher) {
       if (itemDescription != null) {
          return itemDescription;
       } else if(UtilValidate.isNotEmpty(getAttribute("envPriceCalcAttributes")) && UtilValidate.isNotEmpty(((HashMap)getAttribute("envPriceCalcAttributes")).get("name"))) {
            return (String) ((HashMap)getAttribute("envPriceCalcAttributes")).get("name");
       } else {
        GenericValue product = getProduct();
        if (product != null) {
            String productName = ProductContentWrapper.getProductContentAsText(product, "PRODUCT_NAME", this.locale, dispatcher, "html");
    ...
    /** Get the location warehouse id */
    public String getLocation() {
        String location = null;
        GenericValue product = getProduct();
        if (product != null) {
            GenericValue productStock = this.getProductStock();
            if (productStock != null) location = productStock.getString("location");
        }
    ...
    public BigDecimal getWeight() {
        if(UtilValidate.isNotEmpty(getAttribute("envPriceCalcAttributes")) && UtilValidate.isNotEmpty(((HashMap)getAttribute("envPriceCalcAttributes")).get("weight"))) {
            return (BigDecimal) ((HashMap)getAttribute("envPriceCalcAttributes")).get("weight");
        }
   ...
   public List<GenericValue> getFeaturesForSupplier(LocalDispatcher dispatcher,String partyId) {
    ...
    public Map<String, Object> getItemProductInfo() {
        ...
        itemInfo.put("location", this.getLocation());
        GenericValue product = getProduct();
        if (product != null) {
    ...
    public GenericValue getProductStock() {
        if (this._productStock != null) {
        ...
        this._productStock = ProductWorker.getProductStock(productId, this.getDelegator());
