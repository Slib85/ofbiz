...
public class ShoppingCartEvents {
    ...
    public static String addToCart(HttpServletRequest request, HttpServletResponse response) {
        ...
        Map<String, Object> envPriceCalcAttributes = (Map<String, Object>) request.getAttribute("envPriceCalcAttributes");
        if(UtilValidate.isNotEmpty(envPriceCalcAttributes)) {
            paramMap.put("envPriceCalcAttributes", envPriceCalcAttributes);
        }
        Map<String, Object> envArtworkAttributes = (Map<String, Object>) request.getAttribute("envArtworkAttributes");
        if(UtilValidate.isNotEmpty(envArtworkAttributes)) {
            paramMap.put("envArtworkAttributes", envArtworkAttributes);
        }
        Map<String, Object> envQuoteAttributes = (Map<String, Object>) request.getAttribute("envQuoteAttributes");
        if(UtilValidate.isNotEmpty(envQuoteAttributes)) {
            paramMap.put("envQuoteAttributes", envQuoteAttributes);
        }
        Map<String, Object> envQuantityAttributes = (Map<String, Object>) request.getAttribute("envQuantityAttributes");
        if(UtilValidate.isNotEmpty(envQuantityAttributes)) {
            paramMap.put("envQuantityAttributes", envQuantityAttributes);
        }
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        if (paramMap.containsKey("QUANTITY")) {
            ...
            quantityStr = (String) paramMap.remove("quantity");
        } else if(envPriceCalcAttributes.containsKey("quantity")) {
            quantityStr = ((BigDecimal)envPriceCalcAttributes.get("quantity")).toString();
        }
    ...
    public static String loadCartFromOrder(HttpServletRequest request, HttpServletResponse response) {
        ...
        String orderId = request.getParameter("orderId");
        Boolean useOrderPrice = (UtilValidate.isNotEmpty(request.getParameter("useOrderPrice"))) ? Boolean.valueOf(request.getParameter("useOrderPrice")) : false;
        ...
        try {
            ...
            cart.removeAdjustmentByType("DISCOUNT_ADJUSTMENT");
            cart.removeAdjustmentByType("FEE");
            ...
            for (long itr = 1; itr <= groupIndex; itr++) {
                ...
                for (GenericValue adjustment: orderAdjustmentList) {
                    if ("PROMOTION_ADJUSTMENT".equals(adjustment.get("orderAdjustmentTypeId")) || "DISCOUNT_ADJUSTMENT".equals(adjustment.get("orderAdjustmentTypeId")) || "FEE".equals(adjustment.get("orderAdjustmentTypeId"))) {
        ...
        //ENVELOPES CODE
        //we do not need to do promotions for items in the cart
