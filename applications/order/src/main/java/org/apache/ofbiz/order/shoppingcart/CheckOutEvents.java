...
public class CheckOutEvents {
    ...
    public static String createOrder(HttpServletRequest request, HttpServletResponse response) {
        ...
        String webSiteId = UtilValidate.isNotEmpty(request.getAttribute("_WEB_SITE_ID_")) ? (String) request.getAttribute("_WEB_SITE_ID_") : WebSiteWorker.getWebSiteId(request);
