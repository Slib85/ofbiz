            ...
            public void close() throws IOException {
                try {
                    ...
                    if (req != null) {
                        ...
                        out.write(RequestHandler.proxyUrl(rh.makeLink(request, response, buf.toString(), fullPath, secure || request.isSecure() , encode), request));
                    } else if (prefix != null) {
                        if (prefix instanceof TemplateScalarModel) {
                            ...
                            out.write(RequestHandler.proxyUrl(prefixString + bufString, null));
                        }
                    } else {
                        out.write(RequestHandler.proxyUrl(buf.toString(), null));
                    }
                } catch (Exception e) {
