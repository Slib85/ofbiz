        ...
        waitForFinalEvent(function() {
            $.ajax({
                ...
                if(data.success && typeof data.productAssets !== 'undefined') {
                    ...
                    $('.' + self.productSlider).append(
                        `<div class="product-images-single removable">
							<a><img class="product-slide-image" property="image" src="//actionenvelope.scene7.com/is/image/ActionEnvelope/SF-101?hei=375&fit=stretch,1&fmt=png-alpha" /></a>
						</div>`
                    );

                    $('.' + self.assetGrid).append(
                        `<div class="productThumb">
                            <div style="background-image: url(//actionenvelope.scene7.com/is/image/ActionEnvelope/SF-101?fmt=png-alpha&ts=20170501);"></div>
                        </div>`
                    );
