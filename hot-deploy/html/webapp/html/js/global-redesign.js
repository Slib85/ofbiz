            ...
            $('<div />').addClass('atcProductDisplay').append(
                $('<a />').attr({
                    ...
                    $('<div />').addClass('atcpd-row').append(
                        ...
                        $('<p />').addClass('atcpd-itemPrice').html('From ' + formatCurrency(certonaDataList[key]['Price-Current']) + ' / ' + certonaDataList[key].Quantity.replace(/\.00$/, ""))
                    )
                )
            )
        );
	                ...
	                $('<a />').attr({
	                	...
	                	$('<div />').addClass('mpd-itemInfo').append(
		                    ...
		                    $('<div />').addClass('mpd-row').append(
		                        ...
		                        $('<p />').addClass('mpd-itemPrice').html('From ' + formatCurrency(certonaDataList[key]['Price-Current']) + ' / ' + certonaDataList[key].Quantity.replace(/\.00$/, ""))
		                    )
		                )
		            )    
	            )
	    ...
	    if (currentview == 'product') {
						...
						$('<a />').attr({
							...
							$('<div />').addClass('tpd-itemInfo').append(
								...
								$('<div />').addClass('tpd-row').append(
									...
									$('<p />').addClass('tpd-itemPrice').html('From ' + formatCurrency(certonaDataList[key]['Price-Current']) + ' / ' + certonaDataList[key].Quantity.replace(/\.00$/, ""))
								)
							)
						).append(
	    	...
	    	var certonaList = $('<div />').addClass('certonaData certonaCart matchingProducts').append(
	                            ...
	                            $('<div />').addClass('slideIt-container').append(
	                                $('<div />').addClass('slideIt-left').append(
										$("<img />").attr("src", "https://actionenvelope.scene7.com/is/image/ActionEnvelope/angleleft-large?wid=19&amp;hei=36&amp;fmt=png-alpha")
	                                )).append(
	                                $('<div />').addClass('slideIt text-left productImageSlideIt').append(
	                                    $('<div />').attr('bns-certonaList', '')
	                                )
	                                ...
	                                $('<div />').addClass('slideIt-right').append(
										$("<img />").attr("src", "https://actionenvelope.scene7.com/is/image/ActionEnvelope/angleright-large?wid=19&amp;hei=36&amp;fmt=png-alpha")
	                                )
	                            ) 
	                        );
					...
					$('<div />').addClass(currentview == 'product' ? 'rightProductDisplay certonaProductPage' : 'rightProductDisplay').append(
						$('<a />').attr({
							...
							$('<div />').addClass('rpd-row').append(
								...
								$('<p />').addClass('rpd-itemPrice').html('From ' + formatCurrency(certonaDataList[key]['Price-Current']) + ' / ' + certonaDataList[key].Quantity.replace(/\.00$/, ""))
							)
						)
					)
				);
