function BNUpdateLogo(type) {
	if (type == 'fold') {
		$('.jqs-logoImage').attr('src', '/html/img/admin/logoMobile.png');
	}
	else if (type == 'unfold') {
		$('.jqs-logoImage').attr('src', '/html/img/admin/logoDesktop.png');
	}
}
  ...
  var Site = function (_Base) {
    ...
    babelHelpers.createClass(Site, [{
      ...
      value: function startLoading() {
        ...
        /* Removed this because it causes a flashy animation on load
        $BODY.animsition({
          inClass: 'fade-in',
          outClass: 'fade-out',
          inDuration: 800,
