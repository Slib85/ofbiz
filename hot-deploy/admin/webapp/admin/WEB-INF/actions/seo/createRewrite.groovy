...
String module = "createRewrite.groovy";

Map<String, Object> params = EnvUtil.getParameterMap(request);

try {
	if(UtilValidate.isNotEmpty((String) params.get("ruleId")) && UtilValidate.isNotEmpty((String) params.get("webSiteId"))) {
		GenericValue rule = delegator.findOne("RewriteRule", UtilMisc.toMap("ruleId", (String) params.get("ruleId"), "webSiteId", (String) params.get("webSiteId")), false);
		context.rule = rule;
	}
} catch (Exception e) {
...
SeoEvents.getRewriteRules(request, response);
