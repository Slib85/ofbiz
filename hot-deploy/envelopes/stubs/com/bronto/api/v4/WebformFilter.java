 ...
 */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getWebformType(){
                              ...
                              /**
                               * validate the array for WebformType
                               */
                              protected void validateWebformType(java.lang.String[] param){
                              ...
                              */
                              public void setWebformType(java.lang.String[] param){
                                   ...
                                   validateWebformType(param);

                               localWebformTypeTracker = true;
                             ...
                             * @param param java.lang.String
                             */
                             public void addWebformType(java.lang.String param){
                                   if (localWebformType == null){
                                   localWebformType = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localWebformType);
                               list.add(param);
                               this.localWebformType =
                             (java.lang.String[])list.toArray(
                            new java.lang.String[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localTypeTracker){
                             ...
                             if (localWebformType!=null) {
                                   namespace = "";
                                   for (int i = 0;i < localWebformType.length;i++){
                                        
                                            if (localWebformType[i] != null){
                                        
                                                writeStartElement(null, namespace, "webformType", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localWebformType[i]));
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "", "webformType", xmlWriter);
                                  ...
                                  for (int i = 0;i < localWebformType.length;i++){
                                         ...
                                         if (localWebformType[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                              "webformType"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localWebformType[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static WebformFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            WebformFilter object =
                new WebformFilter();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"webformFilter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (WebformFilter)com.bronto.api.v4.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone4){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","webformType").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setWebformType((java.lang.String[])
