 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected java.lang.String localFilterType ;
                                
                            private static java.util.HashMap _table_ = new java.util.HashMap();

                            // Constructor
                            
                                protected FilterType(java.lang.String value, boolean isRegisterValue) {
                                    localFilterType = value;
                                    if (isRegisterValue){
                                        
                                               _table_.put(localFilterType, this);
                                ...
                                public static final FilterType AND =
                                    new FilterType(_AND,true);
                            
                                public static final FilterType OR =
                                    new FilterType(_OR,true);
                            

                                public java.lang.String getValue() { return localFilterType;}

                                public boolean equals(java.lang.Object obj) {return (obj == this);}
                                public int hashCode() { return toString().hashCode();}
                                public java.lang.String toString() {
                                
                                        return localFilterType.toString();
                                       ...
                                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                          ...
                                          if (localFilterType==null){
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("filterType cannot be null !!");
                                                       ...
                                                       xmlWriter.writeCharacters(localFilterType);
    ...
    public static class Factory{
                ...
                public static FilterType fromString(java.lang.String value,java.lang.String namespaceURI)
                      throws java.lang.IllegalArgumentException {
                    try {
                ...
                public static FilterType fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return FilterType.Factory.fromString(content,namespaceUri);
                    } else {
                       return FilterType.Factory.fromString(content,"");
                    }
                }
                    ...
                    if (reader.isStartElement()  || reader.hasText()){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                        ...
                                        if (content.indexOf(":") > 0) {
                                            ...
                                            object = FilterType.Factory.fromString(content,namespaceuri);
                                        } else {
                                            // this seems to be not a qname send and empty namespace incase of it is
                                            // check is done in fromString method
                                            object = FilterType.Factory.fromString(content,"");
                                        }
