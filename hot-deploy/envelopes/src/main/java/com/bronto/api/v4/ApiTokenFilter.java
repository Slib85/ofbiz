 ...
 */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getAccountId(){
                              ...
                              /**
                               * validate the array for AccountId
                               */
                              protected void validateAccountId(java.lang.String[] param){
                             ...
                             * @param param java.lang.String
                             */
                             public void addAccountId(java.lang.String param){
                                   if (localAccountId == null){
                                   localAccountId = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localAccountId);
                               list.add(param);
                               this.localAccountId =
                             (java.lang.String[])list.toArray(
                            new java.lang.String[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":apiTokenFilter",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "apiTokenFilter",
                ...
                if (localTypeTracker){
                             ...
                             if (localAccountId!=null) {
                                   namespace = "";
                                   for (int i = 0;i < localAccountId.length;i++){
                                        
                                            if (localAccountId[i] != null){
                                        
                                                writeStartElement(null, namespace, "accountId", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAccountId[i]));
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "", "accountId", xmlWriter);
                                  ...
                                  for (int i = 0;i < localAccountId.length;i++){
                                         ...
                                         if (localAccountId[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                              "accountId"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localAccountId[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static ApiTokenFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ApiTokenFilter object =
                new ApiTokenFilter();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"apiTokenFilter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ApiTokenFilter)com.bronto.api.v4.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone3){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","accountId").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setAccountId((java.lang.String[])
