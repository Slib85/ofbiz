 ...
 */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getMessageFolderId(){
                              ...
                              /**
                               * validate the array for MessageFolderId
                               */
                              protected void validateMessageFolderId(java.lang.String[] param){
                              ...
                              */
                              public void setMessageFolderId(java.lang.String[] param){
                                   ...
                                   validateMessageFolderId(param);

                               localMessageFolderIdTracker = true;
                             ...
                             * @param param java.lang.String
                             */
                             public void addMessageFolderId(java.lang.String param){
                                   if (localMessageFolderId == null){
                                   localMessageFolderId = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localMessageFolderId);
                               list.add(param);
                               this.localMessageFolderId =
                             (java.lang.String[])list.toArray(
                            new java.lang.String[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localTypeTracker){
                             ...
                             if (localMessageFolderId!=null) {
                                   namespace = "";
                                   for (int i = 0;i < localMessageFolderId.length;i++){
                                        
                                            if (localMessageFolderId[i] != null){
                                        
                                                writeStartElement(null, namespace, "messageFolderId", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMessageFolderId[i]));
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "", "messageFolderId", xmlWriter);
                                  ...
                                  for (int i = 0;i < localMessageFolderId.length;i++){
                                         ...
                                         if (localMessageFolderId[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                              "messageFolderId"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMessageFolderId[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static MessageFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"messageFilter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MessageFilter)com.bronto.api.v4.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone5){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","messageFolderId").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setMessageFolderId((java.lang.String[])
