...
/**
 * SmsDeliveryContactsObject.java
 *
 ...
 */
            ...
            /**
            *  SmsDeliveryContactsObject bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = smsDeliveryContactsObject
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":smsDeliveryContactsObject",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static SmsDeliveryContactsObject parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SmsDeliveryContactsObject object =
                new SmsDeliveryContactsObject();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"smsDeliveryContactsObject".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SmsDeliveryContactsObject)com.bronto.api.v4.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
