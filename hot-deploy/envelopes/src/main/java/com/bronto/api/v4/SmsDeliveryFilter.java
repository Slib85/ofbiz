 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.bronto.api.v4.DateValue[] localStart ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.bronto.api.v4.DateValue[] getStart(){
                               return localStart;
                           }
                              ...
                              /**
                               * validate the array for Start
                               */
                              protected void validateStart(com.bronto.api.v4.DateValue[] param){
                              ...
                              * @param param Start
                              */
                              public void setStart(com.bronto.api.v4.DateValue[] param){
                             ...
                             */
                             public void addStart(com.bronto.api.v4.DateValue param){
                                   if (localStart == null){
                                   localStart = new com.bronto.api.v4.DateValue[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localStart);
                               list.add(param);
                               this.localStart =
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getDeliveryType(){
                              ...
                              /**
                               * validate the array for DeliveryType
                               */
                              protected void validateDeliveryType(java.lang.String[] param){
                              ...
                              */
                              public void setDeliveryType(java.lang.String[] param){
                                   ...
                                   validateDeliveryType(param);

                               localDeliveryTypeTracker = true;
                             ...
                             * @param param java.lang.String
                             */
                             public void addDeliveryType(java.lang.String param){
                                   if (localDeliveryType == null){
                                   localDeliveryType = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localDeliveryType);
                               list.add(param);
                               this.localDeliveryType =
                             (java.lang.String[])list.toArray(
                            new java.lang.String[list.size()]);
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":smsDeliveryFilter",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "smsDeliveryFilter",
                ...
                if (localTypeTracker){
                             ...
                             if (localMessageId!=null) {
                                   ...
                                   for (int i = 0;i < localMessageId.length;i++){
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "", "messageId", xmlWriter);
                                       ...
                                       if (localStart!=null){
                                            for (int i = 0;i < localStart.length;i++){
                                                if (localStart[i] != null){
                                                 localStart[i].serialize(new javax.xml.namespace.QName("","start"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "", "start", xmlWriter);
                             ...
                             if (localDeliveryType!=null) {
                                   namespace = "";
                                   for (int i = 0;i < localDeliveryType.length;i++){
                                        
                                            if (localDeliveryType[i] != null){
                                        
                                                writeStartElement(null, namespace, "deliveryType", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDeliveryType[i]));
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "", "deliveryType", xmlWriter);
                                  ...
                                  for (int i = 0;i < localDeliveryType.length;i++){
                                         ...
                                         if (localDeliveryType[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                              "deliveryType"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDeliveryType[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static SmsDeliveryFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SmsDeliveryFilter object =
                new SmsDeliveryFilter();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"smsDeliveryFilter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SmsDeliveryFilter)com.bronto.api.v4.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list6 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list4.add(com.bronto.api.v4.DateValue.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                                        ...
                                                        while(!loopDone4){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("","start").equals(reader.getName())){
                                                        ...
                                                        object.setStart((com.bronto.api.v4.DateValue[])
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone6){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","deliveryType").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setDeliveryType((java.lang.String[])
