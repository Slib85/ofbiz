 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.bronto.api.v4.MessageFolderFilter localFilter ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.bronto.api.v4.MessageFolderFilter
                           */
                           public  com.bronto.api.v4.MessageFolderFilter getFilter(){
                               return localFilter;
                           }
                            ...
                            /**
                               ...
                               * @param param Filter
                               */
                               public void setFilter(com.bronto.api.v4.MessageFolderFilter param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":readMessageFolders",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "readMessageFolders",
    ...
    public static class Factory{
        ...
        */
        public static ReadMessageFolders parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReadMessageFolders object =
                new ReadMessageFolders();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"readMessageFolders".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReadMessageFolders)com.bronto.api.v4.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","filter").equals(reader.getName())){
                                                ...
                                                object.setFilter(com.bronto.api.v4.MessageFolderFilter.Factory.parse(reader));
