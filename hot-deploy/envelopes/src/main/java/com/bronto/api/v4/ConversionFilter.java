 ...
 */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getContactId(){
                              ...
                              /**
                               * validate the array for ContactId
                               */
                              protected void validateContactId(java.lang.String[] param){
                              ...
                              */
                              public void setContactId(java.lang.String[] param){
                                   ...
                                   validateContactId(param);

                               localContactIdTracker = true;
                             ...
                             */
                             public void addContactId(java.lang.String param){
                                   if (localContactId == null){
                                   localContactId = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localContactId);
                               list.add(param);
                               this.localContactId =
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getOrderId(){
                              ...
                              /**
                               * validate the array for OrderId
                               */
                              protected void validateOrderId(java.lang.String[] param){
                             ...
                             * @param param java.lang.String
                             */
                             public void addOrderId(java.lang.String param){
                                   if (localOrderId == null){
                                   localOrderId = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localOrderId);
                               list.add(param);
                               this.localOrderId =
                             (java.lang.String[])list.toArray(
                            new java.lang.String[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":conversionFilter",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "conversionFilter",
                ...
                if (localContactIdTracker){
                             if (localContactId!=null) {
                                   namespace = "";
                                   for (int i = 0;i < localContactId.length;i++){
                                        
                                            if (localContactId[i] != null){
                                        
                                                writeStartElement(null, namespace, "contactId", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localContactId[i]));
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "", "contactId", xmlWriter);
                             ...
                             if (localOrderId!=null) {
                                   namespace = "";
                                   for (int i = 0;i < localOrderId.length;i++){
                                        
                                            if (localOrderId[i] != null){
                                        
                                                writeStartElement(null, namespace, "orderId", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOrderId[i]));
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "", "orderId", xmlWriter);
                                  ...
                                  for (int i = 0;i < localContactId.length;i++){
                                         ...
                                         if (localContactId[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                              "contactId"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localContactId[i]));
                                          } else {
                                  ...
                                  for (int i = 0;i < localOrderId.length;i++){
                                         ...
                                         if (localOrderId[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                              "orderId"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localOrderId[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static ConversionFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ConversionFilter object =
                new ConversionFilter();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"conversionFilter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ConversionFilter)com.bronto.api.v4.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","contactId").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setContactId((java.lang.String[])
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone4){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","orderId").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setOrderId((java.lang.String[])
