 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.bronto.api.v4.ConversionFilter localFilter ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return com.bronto.api.v4.ConversionFilter
                           */
                           public  com.bronto.api.v4.ConversionFilter getFilter(){
                               return localFilter;
                           }
                            ...
                            /**
                               ...
                               * @param param Filter
                               */
                               public void setFilter(com.bronto.api.v4.ConversionFilter param){
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":readConversions",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "readConversions",
    ...
    public static class Factory{
        ...
        */
        public static ReadConversions parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReadConversions object =
                new ReadConversions();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"readConversions".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReadConversions)com.bronto.api.v4.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","filter").equals(reader.getName())){
                                                ...
                                                object.setFilter(com.bronto.api.v4.ConversionFilter.Factory.parse(reader));
