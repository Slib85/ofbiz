 ...
 */
            ...
            /**
            *  MessageFolderFilter bean class
            */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getParentId(){
                              ...
                              /**
                               * validate the array for ParentId
                               */
                              protected void validateParentId(java.lang.String[] param){
                             ...
                             * @param param java.lang.String
                             */
                             public void addParentId(java.lang.String param){
                                   if (localParentId == null){
                                   localParentId = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localParentId);
                               list.add(param);
                               this.localParentId =
                             (java.lang.String[])list.toArray(
                            new java.lang.String[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":messageFolderFilter",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "messageFolderFilter",
                ...
                if (localTypeTracker){
                             ...
                             if (localParentId!=null) {
                                   namespace = "";
                                   for (int i = 0;i < localParentId.length;i++){
                                        
                                            if (localParentId[i] != null){
                                        
                                                writeStartElement(null, namespace, "parentId", xmlWriter);

                                            
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localParentId[i]));
                                         ...
                                         // write the null attribute
                                        // write null attribute
                                           writeStartElement(null, "", "parentId", xmlWriter);
                                  ...
                                  for (int i = 0;i < localParentId.length;i++){
                                         ...
                                         if (localParentId[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("",
                                                                              "parentId"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localParentId[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static MessageFolderFilter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            MessageFolderFilter object =
                new MessageFolderFilter();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"messageFolderFilter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (MessageFolderFilter)com.bronto.api.v4.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone4){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","parentId").equals(reader.getName())){
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setParentId((java.lang.String[])
