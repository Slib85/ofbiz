<div class="content privacy">
	<div class="content-breadcrumbs">
		<a href="<@ofbizUrl>/main</@ofbizUrl>">Home</a> > Customer Service > Privacy Policy
	</div>
	<div class="section privacy-title">
		<h5 class="no-padding">Privacy Policy</h5>
	</div>
	<div class="section">
		<p>
			At Envelopes.com, we are committed to protecting your privacy and ensuring the security of the information you submit to us. We want your
			use of the Envelopes.com web site, and the services we offer, to be productive and safe. Envelopes.com's Privacy Policy illustrates our
			commitment to your privacy and security.
		</p>
		<p>
			When you register at Envelopes.com, we request your name, e-mail address, phone number, postal address, ZIP Code, state, and country. We
			use this data to manage registrations, and, when you place an order, to contact you about your order and to print your return address on
			Envelopes.com envelopes.
		</p>
		<p>
			We may use your e-mail address, mailing address and/or phone number to contact you regarding new product offerings and other aspects of
			your use of the Envelopes.com web site. If, however, you do not wish to receive such communications, you have the ability to "opt-out" at
			any time.
		</p>
		<p>
			In order to take payment for your order, we collect credit card information. To maintain the highest level of security, your credit card
			information is encrypted using secure sockets layer (SSL) technology. SSL is secure server software that protects against any unauthorized
			access. Envelopes.com uses your credit card information for the sole purpose of accepting payment for your order.
		</p>
		<p>
			From time to time, we may ask you to answer surveys regarding current or future Envelopes.com products. Participation in these surveys is
			always optional. Survey responses are only used in the aggregate, and are never linked to an individual. While our survey data is
			primarily for use within Envelopes.com only, we may occasionally share the aggregate survey data with our development partners (e.g. web
			design, advertising and marketing agencies) in order to facilitate new product development.
		</p>
		<p>
			We may occasionally have a special relationship with another company, an entity that we think of as a marketing partner. By this we mean
			that a portion or version of our web site is integrated into our partner's web site or is integrated with our partner's content or
			branding. In such a circumstance, because we are jointly presenting our web site with our partner, and because the partner is referring
			customers to Envelopes.com, we may agree to share information with the partner as part of our formal contract with that partner,
			including confidentiality and use obligations and restrictions regarding how the partner may use the information. In these instances
			where Envelopes.com and a partner jointly promote Envelopes.com's Services, Envelopes.com may provide the partner certain personal
			information, such as the name, address, and username as a result of the joint promotion of Envelopes.com. We only share this information
			for users coming to Envelopes.com from a partner web site. Again, at the point of registration, you have the option to "opt-out" of
			receiving e-mails or promotional materials. If you have linked to Envelopes.com through a marketing partner as described here, the web
			page you view will be co-branded with the marketing partner. If you would like information about the information use and practices of a
			marketing partner, Envelopes.com recommends that you view the policy of the marketing partner.
		</p>
	</div>
	<div class="section">
	...
	<div class="section">
		<h5>Envelopes.com Website Security</h5>
		<p>
