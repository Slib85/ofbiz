	...
	<div class="container order-detail padding-xs">
		<div>
			<div class="padding-xs generic-container order-summary">
                ...
                <div class="order-shipping-billing-wrap tabular_row">

                    <div class="order-number-information">
                        <h3><span>Order Number:</span> <span>${orderInfo.orderId}</span></h3>
                    </div>
                ...
                <div class="row quick_links">
                	<a class="button-regular proof_approval_link button-cta round-btn navyblue-bckgrd" href="<@ofbizUrl>/proofApproval</@ofbizUrl>">Proof Approval Center</a>
                    <div class="button-regular reorder-button button-cta jqs-reorder element-inactive round-btn navyblue-bckgrd" data-itemUUIDs="${orderInfo.reorderInfo}">Reorder <i class="fa fa-caret-right"></i></div>
                </div>
