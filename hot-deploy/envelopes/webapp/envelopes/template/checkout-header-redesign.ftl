<div id="main-header" class="container checkout-header">
	<div id="header-white-bar" class="padding-right-sm nav-bar padding-top-xxs padding-bottom-xxs padding-left-sm">
		<div class="logo">
			<a href="<@ofbizUrl>/main</@ofbizUrl>"><img class="padding-top-xxs" src="<@ofbizContentUrl>/html/img/logo/logo.png</@ofbizContentUrl>" alt="Envelopes.com" /></a>
		</div>
		<div class="geo-trust">
			<img src="<@ofbizContentUrl>/html/img/temp/geotrust.gif</@ofbizContentUrl>" alt="Geo Trust"/>
		</div>
		<div data-dropdown-target="dropdown-nav-cart" data-dropdown-options="hover reverse-horizontal ignore-reverse-dropdown" class="cart padding-left-xxs">
			<a id="cartContainer" href="<@ofbizUrl>/cart</@ofbizUrl>">
