...
<head>
	...
	<link href="<@ofbizContentUrl>/html/css/master.css</@ofbizContentUrl>?ts=${pageTimestamp?default("65535")}" rel="stylesheet" />
	<link href="<@ofbizContentUrl>/html/css/top.css</@ofbizContentUrl>?ts=${pageTimestamp?default("65535")}" rel="stylesheet" />
	<link href="<@ofbizContentUrl>/html/css/global-redesign.css</@ofbizContentUrl>?ts=${pageTimestamp?default("65535")}" rel="stylesheet" />
	...
	<![endif]-->
	<script src="<@ofbizContentUrl>/html/js/global.min-redesign.js</@ofbizContentUrl>?ts=${pageTimestamp?default("65535")}"></script>
...
<body id="myBody">
	<noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-TQ3CD2" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>