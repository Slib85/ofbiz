...
<#assign isCartEmpty = (orderInfo.lineItems?size == 0)?string('true', 'false') />
	...
	<#if isCartEmpty == "false">
	<#--  <#if swatchBook?exists && enableSwatchbook?exists && enableSwatchbook?c == "true">  -->
	<#if swatchBook?exists>
	<div class="swatchbook jqs-cart-swatchbook">
		<div class="swatchbookContent">
			<h5>The Swatchbook</h5>
			<p><i class="fa fa-circle"></i> Gives designers, printers &amp; industry professional alike, the all-important ability to touch and feel the paper and cardstock before making key decisions.</p>
			<p><i class="fa fa-circle"></i> Over 100 paper options at your fingertips.</p>
		</div>
		<img class="padding-xxs" src="<@ofbizScene7Url>/is/image/ActionEnvelope/SWATCHBOOK?fmt=png-alpha&amp;wid=100</@ofbizScene7Url>">
		<div class="swatchbookPrice">
			...
			<div class="swatchbookButton jqs-add-swatchbook">Add to Cart</div>
		</div>
		<!--<i class="fa fa-times swatchbookClose jqs-close-swatchbook"></i>-->
	</div>
	</#if>
	...
	<div class="coupons-shipping-price row">
		<#--Coupons Section-->
			<div id="apply-coupon" class="coupons text-center">
				...
				<div class="section-container" style="height:auto;">
					...
					<div style="font-size: 13px; padding:5px 0 0 0;"><i>To apply coupons in addition to "FREE99",  you must enter "FREE99" as the last coupon, otherwise they will not combine.</i></div>
				</div>
				</form>
			</div>
		<#--Coupons Section END-->
			...
			<div id="calculate-shipping" class="shipping text-center">
				<form id="shippingOptionsForm" name="shippingOptionsForm" data-bigNameValidateForm="shippingOptionsForm" onsubmit="return false;">
					<div class="section-container">
						...
						<div class="row">
							<div class="small-6 medium-6 large-6 columns" data-bignamevalidateid="shipping_countryGeoId">
							...
							<div class="small-6 medium-6 large-6 columns" data-bignamevalidateid="shipping_postalCode">
	...
	<div class="summary-body">
		...
		<div class="row total-cost-and-coupon margin-top-xxs">
			...
			<div class="coupon">
				...
				<div class="margin-top-xxs"><i>To apply coupons in addition to "FREE99",  you must enter "FREE99" as the last coupon, otherwise they will not combine.</i></div>
			</div>
			</#if>
