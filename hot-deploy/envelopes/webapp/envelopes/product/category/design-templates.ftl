...
<div class="content container category design-templates">
	...
	<div id="jqs-refinements-widget">
        ...
        <p class="category-description no-margin ">
			...
			<div class="positionRel width50">
                ...
                <div class="margin-top-xxs">
					...
					<a href="<@ofbizUrl>/shopBySize</@ofbizUrl>"><div class="button button-cta round-btn navyblue-bckgrd margin-left-xs">Shop by Size <i class="fa fa-caret-right"></i></div></a>
				</div>
				<a href="<@ofbizUrl>/shopBySize</@ofbizUrl>">
					<img class="headerImg" src="<@ofbizScene7Url>/is/image/ActionEnvelope/shopBySizeBlock?fmt=jpeg&amp;wid=475</@ofbizScene7Url>" alt="Shop By Size Block">
		...
		<#if currentView?default("_NA_") != "size-guide">
			<a href="/html/files/addressing.csv" target="_blank"><div class="button button-cta round-btn navyblue-bckgrd">Download Addressing Template <i class="fa fa-caret-right"></i></div></a> 
			<a href="<@ofbizUrl>/shopBySize</@ofbizUrl>"><div class="button button-cta round-btn navyblue-bckgrd margin-left-xs">Shop by Size <i class="fa fa-caret-right"></i></div></a>
		</#if>
