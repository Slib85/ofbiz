<#assign imgFmtQltyGry = 'fmt=jpeg&amp;qlt=75&amp;bgc=ffffff' />
...
<#if product.isActive()?c == "false" && product.showOutOfStockRecommendations()?c == "true">
    <style>
    .ENV_OOS_Header{
        display: table; 
        width: 100%; 
    ...
    .ENV_OOS_Header h3 span{
        display: inline-block;
        width: 10%;
    }
    .ENV_OOS_Header h3 img{
        display: inline-block;
        width: 43%;
    }
    .ENV_OOS_RecProdName{
    ...
    <div id="outOfStockRecommendations" class="reveal-modal reveal-modal-limiter" data-reveal style="position: absolute;">
        <div class="bnc_pop_wrap" style="max-width:800px;">
            <div class="bnc_popup_title">
                <h3>PRODUCT RECOMMENDATIONS</h3>
            </div>
            <div style="display: table; width: 100%; padding: 10px;">
                <div style="display: table-cell; width: auto; vertical-align: middle; text-align: left;">
                    <div style="font-weight: bold; font-size: 20px; color: #0b3360;">BACK IN STOCK SOON</div>
                    <p style="padding: 10px 0;color: #0b3360;">This item is temporarily out of stock.<br /><#if colorHits?size gt 1 || styleHits?size gt 1 || sizeHits?size gt 1>Please see the top in-stock recommended items below.<br /></#if>Thank you for your patience!</p>
                </div>
                <div style="display: table-cell; width: 90px; vertical-align: top;">
                    <img style="display: block; margin: auto;" src="//actionenvelope.scene7.com/is/image/ActionEnvelope/${product.getId()}?wid=149&amp;hei=149&amp;fmt=png-alpha" alt="${product.getName()}" title="${product.getName()}" />
                </div>
            </div>
            <#if colorHits?size gt 1>
                <div class="ENV_OOS_Header">
                    <h3>
                        <img class="tablet_desktop-inline_block" src="<@ofbizScene7Url>/is/image/ActionEnvelope/holiday-lights-left?fmt=png-alpha&amp;wid=340&amp;hei=40</@ofbizScene7Url>" alt="Holiday"/>
                        <span>Color</span>
                        <img class="tablet_desktop-inline_block" src="<@ofbizScene7Url>/is/image/ActionEnvelope/holiday-lights-right?fmt=png-alpha&amp;wid=340&amp;hei=40</@ofbizScene7Url>" alt="Holiday"/>
                    </h3>
                </div>
                <div class="slideIt-container padding-xxs" style="height: 170px;">
                    <div class="slideIt-left">
                        <i class="fa fa-angle-left" style="color: #4a8520; font-size:70px;"></i>
                    </div>
                    <div class="slideIt text-left colorFilterSlideIt">
                        <div>
                            <#list colorHits as colorHit><#if colorHit.getSourceAsMap()?exists && colorHit.getSourceAsMap().productid != product.getId() && (!colorHit.getSourceAsMap().showOutOfStockRecommendations?exists || colorHit.getSourceAsMap().showOutOfStockRecommendations != "Y")><a style="width: 100px; text-align: center;" href="<@ofbizUrl>/product?product_id=${colorHit.getSourceAsMap().productid?if_exists}</@ofbizUrl>">
                                <div><img src="//actionenvelope.scene7.com/is/image/ActionEnvelope/${colorHit.getSourceAsMap().productid?if_exists}?wid=150&amp;hei=150&amp;fmt=png-alpha" alt="${product.getName()}" /></div>
                                <div class="ENV_OOS_RecProdName">${colorHit.getSourceAsMap().color?if_exists}</div>
                            </a></#if></#list>
                        </div>
                    </div>
                    <div class="slideIt-right">
                        <i class="fa fa-angle-right" style="color: #4a8520; font-size:70px;"></i>
                    </div>
                </div>
            </#if>
            <#if styleHits?size gt 1>
                <div class="ENV_OOS_Header">
                    <h3>
                        <img class="tablet_desktop-inline_block" src="<@ofbizScene7Url>/is/image/ActionEnvelope/holiday-lights-left?fmt=png-alpha&amp;wid=340&amp;hei=40</@ofbizScene7Url>" alt="Holiday"/>
                        <span>Style</span>
                ...
                <div class="slideIt-container padding-xxs" style="height: 170px;">
                    ...
                    <div class="slideIt text-left colorFilterSlideIt">
                        <div>
                            <#list styleHits as styleHit><#if styleHit.getSourceAsMap()?exists && styleHit.getSourceAsMap().productid != product.getId() && (!styleHit.getSourceAsMap().showOutOfStockRecommendations?exists || styleHit.getSourceAsMap().showOutOfStockRecommendations != "Y")><a style="width: 100px; text-align: center;" href="<@ofbizUrl>/product?product_id=${styleHit.getSourceAsMap().productid?if_exists}</@ofbizUrl>">
                                <div><img src="//actionenvelope.scene7.com/is/image/ActionEnvelope/${styleHit.getSourceAsMap().productid?if_exists}?wid=150&amp;hei=150&amp;fmt=png-alpha" alt="${product.getName()}" /></div>
                                <div class="ENV_OOS_RecProdName"><#if styleHit.getSourceAsMap().productstyle?exists>${styleHit.getSourceAsMap().productstyle.get(0)?if_exists}</#if></div>
                            </a></#if></#list>
                        </div>
                    </div>
                    <div class="slideIt-right">
            ...
            <#if sizeHits?size gt 1>
                ...
                <div class="slideIt-container padding-xxs" style="height: 170px;">
                    ...
                    <div class="slideIt text-left colorFilterSlideIt">
                        <div>
                            <#list sizeHits as sizeHit><#if sizeHit.getSourceAsMap()?exists && sizeHit.getSourceAsMap().productid != product.getId() && (!sizeHit.getSourceAsMap().showOutOfStockRecommendations?exists || sizeHit.getSourceAsMap().showOutOfStockRecommendations != "Y")><a style="width: 100px; text-align: center;" href="<@ofbizUrl>/product?product_id=${sizeHit.getSourceAsMap().productid?if_exists}</@ofbizUrl>">
                                <div><img src="//actionenvelope.scene7.com/is/image/ActionEnvelope/${sizeHit.getSourceAsMap().productid?if_exists}?wid=150&amp;hei=150&amp;fmt=png-alpha" alt="${product.getName()}" /></div>
                                <div class="ENV_OOS_RecProdName">${sizeHit.getSourceAsMap().get("size")?if_exists}</div>
                            </a></#if></#list>
                        </div>
                    </div>
                    <div class="slideIt-right">
            ...
            <img class="tablet_desktop-inline_block" style="border-radius: 7px;" src="<@ofbizScene7Url>/is/image/ActionEnvelope/holiday-plant-decor-banner?fmt=jpeg&amp;wid=1440&amp;hei=105</@ofbizScene7Url>" alt="Holiday"/>
        </div>
    </div>
    
    <script>
        $(document).ready(function() {
            $('#outOfStockRecommendations').foundation('reveal', 'open');
        });
    </script>
</#if>
...
<#if product?exists && (!designActive?has_content || designActive)>
    ...
    <link href="<@ofbizContentUrl>/html/css/product/sideBarPanelNEW-redesign.css</@ofbizContentUrl>?ts=${pageTimestamp?default("65535")}" rel="stylesheet" />
    <link href="<@ofbizContentUrl>/html/css/product/productNEW-redesign.css</@ofbizContentUrl>?ts=${pageTimestamp?default("65535")}" rel="stylesheet" />
    <div vocab="https://schema.org/" typeof="Product" class="container product hproduct">
        ...
        <div class="productContent">
            <div class="productContentLeft">
                <h1 property="name" class="fn jqs-productname"><#if designName?has_content>${designName?if_exists}<#else>${product.getName()?if_exists}<#if product.getColor()?exists> - ${product.getColor()}</#if></#if></h1>
                <div>
                            ...
                            <div class="jqs-prodassets imageSelection">
                                ...
                                <#list productAssets as asset>
                                    <#if (asset.assetType == "printed" && designId?has_content && designId == asset.designId) || (asset.assetType != "printed" && !designId?has_content)>
                                        <div data-selected="<#if hasDefault == "y" && asset.assetDefault?exists && asset.assetDefault == "Y">y<#else>n</#if>" data-type="${asset.assetType}" data-src="<#if asset.assetType == "video"><#if !firstVideo?exists><#assign firstVideo = "//fast.wistia.net/embed/iframe/${asset.assetName}" /></#if>//fast.wistia.net/embed/iframe/${asset.assetName}<#else>//actionenvelope.scene7.com/is/image/ActionEnvelope/${asset.assetName}?hei=413&amp;wid=510&amp;fmt=jpeg&amp;qlt=70&amp;bgc=ffffff</#if>">
                                            <img src="<#if asset.assetType == "video">//embed-ssl.wistia.com/deliveries/${asset.assetThumbnail?if_exists}.jpg?image_crop_resized=48x36<#else>//actionenvelope.scene7.com/is/image/ActionEnvelope/${asset.assetName}?hei=48&amp;fmt=jpeg&amp;qlt=85&amp;bgc=ffffff</#if>" alt="<#if designName?has_content>${designName?if_exists}<#else>${product.getName()?if_exists}</#if>" />
                ...
                <#if product.isPrintable()?c == "true">
                    <div class="tablet-desktop-only row jqs-productSpecs">
            ...
            <div class="productContentRight">
                    ...
                    <div id="freeDesignReview" class="reveal-modal reveal-modal-limiter" data-reveal>
                        <div class="padding-bottom-xs">
                            ...
                            <div class="padding-left-xs padding-right-xs">
                                After checkout, you'll receive a <span>FREE</span> emailed proof within 1 business day. Once you approve your proof, your order will enter print production.<br />
                ...
                <div class="productPageSizeStyle desktop-only">
                    <div class="productPageSize">
                        ...
                        <div id="sidebar-sizeList" class="sidebarPanel sizesList jqs-scrollable">
                    ...
                    <div class="productPageStyle">
                        ...
                        <div id="sidebar-styleList" class="sidebarPanel stylesList jqs-scrollable">
                            <div class="colorTextureHeading">
                                <div class="stickyTextureHeading">
                ...
                <div class="<#if product.isActive()?c == "false"> discontinuedContainer</#if>">
                    <#if product.isActive()?c == "true">
                                    ...
                                    <div class="foldersTabularRow folderDisplayTable productColorSelection" style="height: 55px; background: url('<@ofbizScene7Url>/is/image/ActionEnvelope/${product.getColor()?if_exists?replace("&.*?;", "", "r")?replace("[^a-zA-Z0-9_]", "", "r")?lower_case}</@ofbizScene7Url>?wid=1100&hei=92&ts=1') 100% repeat; background-color: #${product.getHex()?default("ffffff")}; background-position: right;">
                                        <div bns-colorselecttext class="textBold paddingLeft10">
                                            ...
                                            <div class="colorPeelAndPress">
                                                ...
                                                <#if product.isSpecialQuantityOffer()?c == "false">
                                                    ...
                                                    <div class="foldersTabularRow folderDisplayTable productColorSelection" style="background: url('<@ofbizScene7Url>/is/image/ActionEnvelope/${variant.get("color")?if_exists?replace("&.*?;", "", "r")?replace("[^a-zA-Z0-9_]", "", "r")?lower_case}</@ofbizScene7Url>?fmt=jpeg&qlt=50&wid=1100&hei=92&ts=1') 100% repeat; background-color: ${variant.get("hex")}; background-position: right;">
                                                        ...
                                                        <div bns-colorselecttext class="textBold paddingLeft10">
                                                            ...
                                                            <div class="colorPeelAndPress">
                                                                ...
                                                                <#if variant.get("isSpecialQuantityOffer")?c == "false">
                                ...
                                <div id="sidebar-printingOption" class="sidebarPanel printingOption jqs-scrollable">
                                    ...
                                    <div class="colorTextureBody">
                                        <div class="colorTextureBodyInner" style="padding: 0;">
                                            ...
                                            <div bns-selection class="selectList jqs-selectList mobile-only" data-key="plainOrPrinted" data-additionalkey="designOrUpload" data-value="printed" data-additionalvalue="returnAddress" data-selected="false" data-target="printingOption">
                                                <div class="foldersTabularRow folderDisplayTable printingOptionContent">
                                                    <div selection-removeonselect class="paddingLeft10 width40"><span class="selectCheckbox"></span></div>
                                                    <div class="printingIconContainer"><i class="fa fa-pencil-square-o"></i></div>
                                                    <div class="row">
                                                        <div class="selectionHeader">Add a Return Address</div>
                                                    </div>
                                                    <i selection-showonselect class="fa fa-caret-right productCaretSidebar"></i>
                                                </div>
                                            </div>
                            ...
                            <div class="option hidden tablet-desktop-only" bns-customization>
                                <div>
                                    <div class="optionButton addRecipientAddressingButton jqs-addaddresses jqs-selectList" data-target="addressing" data-key="addresses" data-holder data-price data-selected="false" data-value="true" data-total="0" onclick="productPage.showGrid('manual', 0)">
                                        <img class="recipientAddressingBar" src="<@ofbizScene7Url>/is/image/ActionEnvelope/Recipient-Addressing-Button?fmt=jpeg&amp;qlt=100</@ofbizScene7Url>" alt="Add Recipient Addressing" />
                        ...
                        <div class="optionContentBlock option hidden" bns-customization bns-rush_production>
                            ...
                            <div>
                                <div id="productionTime" class="selectList selectListParent sidebarToggle productionTime" data-sidebar-name="sidebar-productionTime" selection-selectlistname="productionTime" data-ignorecaret="">
                                    <div class="foldersTabularRow folderDisplayTable printingOptionContent">
                                        <div class="printingIconContainer"><i class="fa fa-envelope"></i></div>
                        ...
                        <div bns-return_address_content class="hidden optionContentBlock">
                            <h5>Return Address: </h5>
                            <div>
                                <div>
                                    <div>First Name:</div>
                                    <input type="text" value="" name="return_address_fname" autocomplete="off">
                                    <div>Last Name:</div>
                                    <input type="text" value="" name="return_address_lname" autocomplete="off">
                                    <div>Address:</div>
                                    <input type="text" value="" name="return_address_address1" autocomplete="off">
                                    <div>City:</div>
                                    <input type="text" value="" name="return_address_city" autocomplete="off">
                                    <div>State:</div>
                                    <input type="text" value="" name="return_address_state" autocomplete="off">
                                    <div>Zip:</div>
                                    <input type="text" value="" name="return_address_zip" autocomplete="off">
                                    <div>Font:</div>
                                    <div class="envelope-select">
                                        <select bns-targeted_style="font-family" name="return_address_font">
                                            ...
                                            <option style="font-family: &quot;Allura&quot;" value="&quot;Allura&quot;">Allura</option>
                                        </select>
                                    </div>
                                    <div>Font Size:</div>
                                    <div class="envelope-select">
                                        <select bns-targeted_style="font-size" name="return_address_size">
                                    ...
                                    <div>Font Color:</div>
                                    <div class="envelope-select">
                                        <select bns-targeted_style="color" name="return_address_color">
                                            <option value="#000000" selected>Midnight Black</option>
                                            <option value="#ffffff">White</option>
                                            <option value="#002856">Navy</option>
                                            <option value="#005740">Racing Green</option>
                                            <option value="#FDDD3F">Sunflower</option>
                                            <option value="#FF9016">Mandarin</option>
                                            <option value="#C20430">Ruby Red</option>
                                            <option value="#CB007C">Magenta</option>
                                            <option value="#2E1B46">Deep Purple</option>
                                            <option value="#6C6864">Smoke</option>
                                        </select>
                                    </div>
                                    <div>Printing Location:</div>
                                    <div class="envelope-select">
                                        <select name="return_address_printing_location">
                                            <option value="Top Left Corner" selected>Top Left Corner</option>
                                            <option value="Back Flap">Back Flap</option>
                                        </select>
                                    </div>
                                    <div>Return Address Preview:</div>
                                    <textarea style="resize: none; height: 85px;" name="return_address_preview" readonly></textarea>
                                </div>
                            </div>
                        </div>
                                ...
                                <#list product.getPrices().keySet() as quantities>
                                    <#if quantities_index == 0>
                                        ...
                                        <div id="quantityPriceSelection" class="qpsListItems selectList selectListParent quantityPriceSelection sidebarToggle jqs-sidebarToggle jqs-quantityTest" data-sidebar-name="sidebar-quantityList" selection-selectlistname="quantityList">
                                            ...
                                            <#if product.isSpecialQuantityOffer()?c == "true"><div class="originalPriceDisplay<#if product.percentSavings()?default("0") == 0> hidden</#if>"><#if product.percentSavings()?default("0") gt 0 && product.getOriginalPrices().get(quantities).price?exists><strike>$${product.getOriginalPrices().get(quantities).price?string[",##0.##"]}</strike></#if></div></#if>
                                            <div class="priceDisplay">$${product.getPrices().get(quantities).price?string[",##0.##"]}</div>
                                            <#if product.isSpecialQuantityOffer()?c == "true"><div class="savingsDisplay<#if product.percentSavings()?default("0") == 0> hidden</#if>"><#if product.percentSavings()?default("0") gt 0>Save ${product.percentSavings()?default("0")}%</#if></div></#if>
                                            ...
                                            <div class="jqs-pricelist">
                                                <#list product.getPrices().keySet() as quantities>
                                                    ...
                                                    <div bns-selection class="qpsListItems no-padding jqs-selectList selectList <#if quantities_index == 0> slSelected</#if>" data-target="quantityPriceSelection" data-qty="${quantities}" data-price="${product.getPrices().get(quantities).price}" data-originalPrice="<#if product.percentSavings()?default("0") gt 0 && product.getOriginalPrices().get(quantities).price?exists>${product.getOriginalPrices().get(quantities).price}<#else>${product.getPrices().get(quantities).price}</#if>">
                                                        ...
                                                        <div class="width95 quantityDisplay">${quantities?string[",##0"]} Qty.</div>
                                                        <div <#if product.isSpecialQuantityOffer()?c == "false">selection-removeonselect</#if> class="originalPriceDisplay<#if product.percentSavings()?default("0") == 0> hidden</#if>"><#if product.percentSavings()?default("0") gt 0 && product.getOriginalPrices().get(quantities).price?exists><strike>$${product.getOriginalPrices().get(quantities).price?string[",##0.##"]}</strike></#if></div>
                                                        <div class="priceDisplay">$${product.getPrices().get(quantities).price?string[",##0.##"]}</div>
                                                        <div <#if product.isSpecialQuantityOffer()?c == "false">selection-removeonselect</#if> class="savingsDisplay<#if product.percentSavings()?default("0") == 0> hidden</#if>"><#if product.percentSavings()?default("0") gt 0>Save ${product.percentSavings()?default("0")}%</#if></div>
                                                        <#if product.percentSavings()?default("0") == 0><div class="jqs-pricePerUnit pricePerUnitDisplay">${(product.getPrices().get(quantities).price?number / quantities?string["##0"]?number)?string.currency}/each</div></#if>
                                                        <div class="jqs-subfreeshipnote freeshipnote <#if product.getPrices().get(quantities).price lt globalContext.freeShippingAmount?default("250")>hidden</#if>"> + <i class="fa fa-truck"></i> Ships FREE w/code</div>
                    ...
                    <#else>
                        <div class="discontinuedText"><#if product.showOutOfStockRecommendations()?c == "true">BACK IN STOCK SOON<#else>Discontinued</#if></div>
                    </#if>
                </div>
                <#if product.isActive()?c == "true">
        ...
        <div id="reviews" class="customer-reviews margin-top-xxs" style="max-width: 1360px; margin: 0 auto;">
        ...
        <div>
            ...
            <div class="padding-top-xxs padding-bottom-xxs padding-left-xs padding-right-xs">
                <div class="padding-top-xxs padding-bottom-xxs padding-left-xs padding-right-xs uploadBackgroundColor">
                    ...
                    <form id="uploadScene7Files" method="POST" action="<@ofbizUrl>/uploadScene7Files</@ofbizUrl>" enctype="multipart/form-data">
                        ...
                        <div class="fileContainer jqs-filecontainer">
                            <div class="dropzone placeholder">
                                ...
                                <div bns-removeonupload class="design-template-block dtb-list">
                    ...
                    <div class="bnc_artwork_message tabular_row">
                        <div>
                            <img src="<@ofbizScene7Url>/is/image/ActionEnvelope/envelope-blue-theme-icon?fmt=png-alpha&amp;wid=60&amp;ts=3</@ofbizScene7Url>" alt="" />
                        </div>
                        <div>
                            <p><span><strong>Please note:</strong> You <u>cannot</u> upload multiple designs for the same item. They must be added to the cart as different items. (ex. For 250 qty envelopes, you cannot have 50 with one design and 200 with another)</span></p>
                        </div>
                    </div>
                    <div class="sendFilesLater tabular_row">
                        <div>
                            <img src="<@ofbizScene7Url>/is/image/ActionEnvelope/envelope-time-yellow-theme-icon?fmt=png-alpha&amp;wid=60&amp;ts=3</@ofbizScene7Url>" alt="" />
                        </div>
                        <div>
                            <div>
                                <label class="checkmark_container">
                                    <input type="checkbox">
                                    <span class="bnc_checkmark"></span>
                                </label>
                            </div>
                            <#--  <input type="checkbox">  -->
                            <div>
                    ...
                    <div class="optionRow">
                        ...
                        <div>
                            <div class="round-btn button button-cta padding-xxs jqs-closemodal">Next <i class="fa fa-caret-right"></i></div>
                        </div>
                    </div>
                    <div class="uploadNote margin-top-xs">
                        <span>*Please Note:</span> Metallic ink can only be printed on quantities over 500. Any artwork printed in white ink, requires a <strong>VECTOR</strong> file. Accepted file types are AI, EPS, PDF or SVG only.</div>
                </div>
            </div>
            <div class="row">
                <div class="left margin-left-xxs margin-right-xxs padding-left-xxs padding-right-xxs margin-bottom-xxs reviewProofText">
                    ...
                    <p class="margin-top-xxs">1.) Proofs are ready for review within 1 business day of order placement or sooner. Once you approve your proof, your order will enter print production.</p>
                    ...
                    <p><span>Please Note: </span>Proof Approvals after 4pm EST are considered next business day. If you do not approve your proof within 5 business days, your order will automatically enter production.</p>
                </div>
            </div>
        </div>
        ...
        buildColorList = function(selectColorProductId, ignoreAction) {
            ...
            for (var productIdKey in sizeAndStyleData["BY_SIZE"][sizeValue][styleValue]) {
                ...
                var colorElement = $('<div />').attr({
                    ...
                    'data-isspecialquantityoffer': (typeof productData.isSpecialQuantityOffer != 'undefined' && productData.isSpecialQuantityOffer != null ? productData.isSpecialQuantityOffer : 'false')
                }).append(
    ...
    <script>
        ...
        function updateReturnAddressPreview(styleMap) {
            $("[name=\"return_address_preview\"]").html(
            ...
            if (typeof styleMap == "object") {
                for (var key in styleMap) {
                    if (styleMap.hasOwnProperty(key)) {
                        $("[name=\"return_address_preview\"]").css(key, styleMap[key]);
                    }
                }
            }
        }

        $("[name=\"return_address_fname\"], [name=\"return_address_lname\"], [name=\"return_address_address1\"], [name=\"return_address_city\"], [name=\"return_address_state\"], [name=\"return_address_zip\"]").on("input focusout", function() {
            updateReturnAddressPreview();
        });

        $("[name=\"return_address_font\"], [name=\"return_address_size\"], [name=\"return_address_color\"]").on("change", function() {
            if (typeof $(this).attr("bns-targeted_style") != "undefined") {
                var myObj = {}
                myObj[$(this).attr("bns-targeted_style")] = $(this).val();
                updateReturnAddressPreview(myObj);
            }
        });

        $("[bns-return_address_content] select").each(function() {
            var myObj = {}
            myObj[$(this).attr("bns-targeted_style")] = $(this).val();
            updateReturnAddressPreview(myObj);
        });
