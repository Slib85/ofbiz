            ...
            <div class="genericPageHeader jqs-category-header">
                <div class="section no-margin margin-top-xxs no-padding desktop-only">
                    <div class="pageHeaderText">
                        <h1 class="jqs-category-title category-title"><#if seoH1?has_content>${seoH1?replace("&lt;", "<")?replace("&gt;", ">")?replace("&#x2f;", "/")}<#elseif bannerData?has_content>${bannerData.bannerName?if_exists}</#if></h1>
                    </div>
