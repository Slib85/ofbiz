...
<div class="couponList content-body">
        ...
        <div class="section signUp">
            <div onclick="_ltk.Popup.openManualByName('Popup2021-Envelopes Holiday-Manual');">
                ...
                <div class="discount margin-bottom-xxs subscribeHeight">
                    * Discount on orders of $50 or more and applied before shipping and applicable taxes<br /><br /><br />
                </div>
                <div class="button button-cta padding-left-xs padding-right-xs no-margin margin-top-xxs">Sign Up <i class="fa fa-caret-right"></i></div>
            </div>
        </div>
    </div>
    <div>
        <div class="section customOrange">
            <a href="<@ofbizUrl>/search?w=*&af=onsale:sale%20onsale:clearance</@ofbizUrl>">
                ...
                <div class="button button-cta padding-left-xs padding-right-xs no-margin margin-top-xxs">Shop Now <i class="fa fa-caret-right"></i></div>
            </a>
        </div>
    </div>
    <div>
        <div class="section">
            <a id="applyCoupon" href="<@ofbizUrl>/applyPromo?productPromoCodeId=FREE${globalContext.freeShippingAmount?default("299")}&amp;saveResponse=true</@ofbizUrl>">
                ...
                <div class="button button-cta padding-left-xs padding-right-xs no-margin margin-top-xxs">Apply Coupon <i class="fa fa-caret-right"></i></div>
            </a>
        </div>
    </div>
    <#assign usedPromo = "" />
    ...
    <div>
        <div class="section envCoupBlock">
    ...
    <div>
        <div class="section">
            <a href="<@ofbizUrl>/tradePro</@ofbizUrl>">
                ...
                <div class="button button-cta padding-left-xs padding-right-xs no-margin margin-top-xxs">Apply Now <i class="fa fa-caret-right"></i></div>
            </a>
        </div>
    </div>
    <div>
        <div class="section foldersCoupon">
            <a href="https://www.folders.com" target="_blank">
                ...
                <div class="button foldersButton padding-left-xs padding-right-xs no-margin margin-top-xxs">Shop Folders.com <i class="fa fa-caret-right"></i></div>
            </a>
        </div>
    </div>
</div>