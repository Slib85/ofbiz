...
<link href="<@ofbizContentUrl>/html/css/folders/account/account.css</@ofbizContentUrl>" rel="stylesheet">

<div class="foldersContainer account">
	<div class="foldersContainerContent">
		<div class="foldersTabularRow accountHeader textCenter">
			<div>
		...
		<div class="foldersTabularRow accountContent">
			<div class="accountContentLeft">
				<div class="foldersTabularRow foldersContainerContent">
					<div class="textCenter accountInfoHeader">
						<h2>Orders</h2>
				...
				<div class="foldersTabularRow foldersContainerContent marginTop20">
					<div class="textCenter accountInfoHeader">
						<h2>Account</h2>
			...
			<div class="accountContentRight tabletDesktop-tableCell">
				<div class="foldersContainerContent contactUs padding20">
