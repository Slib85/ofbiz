...
<link href="<@ofbizContentUrl>/html/css/folders/account/myQuotes-redesign.css</@ofbizContentUrl>" rel="stylesheet" />

<div class="foldersContainer foldersContainerLimiter account">
    <div class="foldersBreadcrumbs">
        <a href="<@ofbizUrl>/account</@ofbizUrl>">My Account</a> > My Quotes
    </div>

    <div class="myQuotesHeader">
        <div class="myQuotesHeaderContent">
            <h1 class="ftc-blue">My Quotes</h1>
        </div>
    </div>
    ...
    <div class="foldersContainerContent myQuotes">
        ...
        <div class="foldersRow myQuotesRepInfoWrap">
            <div class="myQuotesRepInfoContent">
                <div class="myQuotesRepInfoBox">
                    <h3 class="ftc-blue">Sales Rep. Information</h3>
                </div>
                <div class="myQuotesRepInfoBox">
