...
<div id="foldersHeader" class="foldersHeader">
    ...
    <#--  <a class="folMessage" href="<@ofbizUrl>/search?w=*&af=sale:clearance%20sale:sale&page=0</@ofbizUrl>">CLEARANCE ITEMS: UP TO 75% OFF - LIMITED TIME ONLY - SHOP NOW</a>  -->
    <#-- END PROMO -->
    ...
    <div class="foldersTabularRow secondNav">
        ...
        <div class="searchContainer tabletDesktop-tableCell">
            <#if currentView?exists && currentView == "main">
                <div id="sli-search" class="search" itemscope itemtype="http://schema.org/WebSite">
                    ...
                    <form name="globalsearch" method="GET" action="<@ofbizUrl>/search</@ofbizUrl>" itemprop="potentialAction" itemscope itemtype="http://schema.org/SearchAction">
                        ...
                        <input itemprop="query-input" data-dropdown-target="dropdown-sli-search-results" data-dropdown-alternate-parent="sli-search" data-dropdown-options="focus shadowed(foldersHeader) ignore-reverse-dropdown ignore-scroll" type="text" name="w" value="" placeholder="What are you looking for?" autocomplete="off" />
                    </form>
                </div>
            <#else>
                <div id="sli-search" class="search">
                    ...
                    <form name="globalsearch" method="GET" action="<@ofbizUrl>/search</@ofbizUrl>">
                        <input data-dropdown-target="dropdown-sli-search-results" data-dropdown-alternate-parent="sli-search" data-dropdown-options="focus shadowed(foldersHeader) ignore-reverse-dropdown ignore-scroll" type="text" name="w" value="" placeholder="What are you looking for?" autocomplete="off" />
                    </form>
                </div>
            </#if>
        </div>
        ...
        <a href="<@ofbizUrl>/specialtyProducts</@ofbizUrl>" class="inheritTextColor customQuote textCenter gtm-captureQuote">
            <i class="fa fa-calculator gtm-captureQuote"></i>
            <div class="gtm-captureQuote">Custom Quote</div>
        </a>
        <a href="<@ofbizUrl>/account</@ofbizUrl>" class="inheritTextColor reorder textCenter noMobile">
            <i class="fa fa-refresh"></i>
            <div>Reorder</div>
        </a>
        <a href="<@ofbizUrl>/account</@ofbizUrl>" class="inheritTextColor myAccount textCenter">
            <i class="fa fa-user noMargin"></i>
            <div><span class="noMobile">My</span> Account</div>
        </a>
        <a id="cartContainer" href="<@ofbizUrl>/cart</@ofbizUrl>" class="inheritTextColor cart textCenter">
            <span id="jqs-mini-cart-count">(0)</span>
            <i class="fa fa-shopping-cart ftc-green noMargin"></i>
            <div bns-mini-cart-total id="jqs-mini-cart-total">Empty</div>
        </a>
    </div>
    <div class="textCenter megaMenuContainer">
        <div id="megaMenuContainer" class="foldersTabularRow">
            <div class="dropdown-hover-navigation" data-dropdown-target="dropdown-megaMenuCustomFolders" data-dropdown-alternate-parent="megaMenuContainer" data-dropdown-options="hover shadowed(foldersHeader) ignore-reverse-dropdown delayed-100">
                Custom Folders <i class="fa fa-caret-down"></i>
            </div>
            <div class="dropdown-hover-navigation" data-dropdown-target="dropdown-megaMenuBlankFolders" data-dropdown-alternate-parent="megaMenuContainer" data-dropdown-options="hover shadowed(foldersHeader) ignore-reverse-dropdown delayed-100">
                Blank Folders <i class="fa fa-caret-down"></i>
            </div>
            <div class="dropdown-hover-navigation" data-dropdown-target="dropdown-megaMenuCertificateHoldersDiplomaCovers" data-dropdown-alternate-parent="megaMenuContainer" data-dropdown-options="hover shadowed(foldersHeader) ignore-reverse-dropdown delayed-100">
                Certificate Holders &amp; Diploma Covers <i class="fa fa-caret-down"></i>
            </div>
            <div class="dropdown-hover-navigation" data-dropdown-target="dropdown-megaMailersAndEnvelopes" data-dropdown-options="hover shadowed(foldersHeader) ignore-reverse-dropdown delayed-100  reverse-horizontal">
                Mailers &amp; Envelopes <i class="fa fa-caret-down"></i>
            </div>
            <#--  <div class="dropdown-hover-navigation" id="folderShopLink">
                <a href="<@ofbizUrl>/search?w=*&af=new:y</@ofbizUrl>" class="folderShopLinkElement">New Arrivals</a>
            </div>  -->
            <#if (currentTimestamp?default(now?datetime) gte "2021-06-01 00:00:00.000"?datetime && currentTimestamp?default(now?datetime) lte "2021-06-09 23:59:59.000"?datetime)>
            <a href="<@ofbizUrl>/taxShop</@ofbizUrl>" class="dropdown-hover-navigation" style="width: 12%; color: #ffffff; background-color: #638c36;">
                Tax Shop <i class="fa fa-calculator desktop-inline_block" style="font-size: 16px;"></i>
            </a>
            <#elseif (currentTimestamp?default(now?datetime) gte "2021-06-10 00:00:00.000"?datetime && currentTimestamp?default(now?datetime) lte "2021-07-26 23:59:59.000"?datetime)>
            <a href="<@ofbizUrl>/graduationShop</@ofbizUrl>" class="dropdown-hover-navigation" style="width: 16%; color: #ffffff; background-color: #638c36;">Graduation Shop <img src="<@ofbizScene7Url>/is/image/ActionEnvelope/graduation-gap-icon?fmt=png-alpha&amp;wid=20&amp;ts=1</@ofbizScene7Url>" alt="The Graduation Shop" /> </a>
            <#elseif (currentTimestamp?default(now?datetime) gte "2021-07-27 00:00:00.000"?datetime)>
            <a href="<@ofbizUrl>/backToSchool</@ofbizUrl>" class="dropdown-hover-navigation" style="width: 16%; color: #ffffff; background-color: #638c36;">Back To School Shop</a>
            </#if>
            <div class="dropdown-hover-navigation" id="folderShopLink">
                <a href="<@ofbizUrl>/search?w=*&af=sale:clearance%20sale:sale</@ofbizUrl>" class="folderShopLinkElement">Clearance</a>
            </div>
        </div>
    </div>
    <#if currentView != "main">
    ...
    <div class="foldersRow headerBanner">
        ...
        <div class="foldersColumn large4 small12 priceMatch desktop-block">
            <a href="<@ofbizUrl>/specialtyProducts</@ofbizUrl>" class="textCenter gtm-captureQuote">
                <i class="fa fa-calculator gtm-captureQuote"></i> 
                <p class="gtm-captureQuote"><span class="gtm-captureQuote">Endless Options!</span> Get a Custom Quote <i class="fa fa-caret-right gtm-captureQuote"></i></p>
            </a>
        </div>
    </div>
    <div class="fourthNav mobile-block">
