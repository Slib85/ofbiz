...
<div class="checkout foldersNewLimiter paddingTop20">
                ...
                <form id="loginForm" name="loginForm" action="<@ofbizUrl>/login-action</@ofbizUrl>" method="post">
                    ...
                    <div class="row margin-top-xs margin-left-xxs">
                        ...
                        <div class="small-12 medium-3 large-2 columns">
                            <a class="checkoutJE janrainEngage">Or login using <img src="<@ofbizScene7Url>/is/image/ActionEnvelope/social_login_button_v2?fmt=png-alpha&amp;wid=170&amp;ts=1</@ofbizScene7Url>" alt="Social Login" /></a>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div>
                            ...
                            <div class="jqs-shipping">
                                ...
                                <div class="row">
                                    <div class="small-12 medium-6 large-6 columns" data-bignamevalidateid="shipping_firstName">
                                        <input class="jqs-first-name" name="shipping_firstName" type="text" placeholder="First Name" data-bignamevalidate="shipping_firstName" data-bignamevalidatetype="required" data-bignamevalidateerrortitle="First Name"/>
                                    </div>
                                    <div class="small-12 medium-6 large-6 columns" data-bignamevalidateid="shipping_lastName">
                                        <input class="jqs-last-name" name="shipping_lastName" type="text" placeholder="Last Name" data-bignamevalidate="shipping_lastName" data-bignamevalidatetype="required" data-bignamevalidateerrortitle="Last Name"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="small-12 medium-12 large-12 columns">
                                        <input class="jqs-company-name" name="shipping_companyName" type="text" placeholder="Company (Optional)"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="small-12 medium-12 large-12 columns" data-bignamevalidateid="shipping_address1">
                                        <input class="jqs-address1" name="shipping_address1" type="text" placeholder="Address Line 1" data-bignamevalidate="shipping_address1" data-bignamevalidatetype="required" data-bignamevalidateerrortitle="Address"/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="small-12 medium-12 large-12 columns">
                                        <input class="jqs-address2" name="shipping_address2" type="text" placeholder="Address Line 2 (Optional)" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="small-12 medium-3 large-3 columns" data-bignamevalidateid="shipping_city">
                                        <input class="jqs-city" name="shipping_city"type="text" placeholder="City" data-bignamevalidate="shipping_city" data-bignamevalidatetype="required" data-bignamevalidateerrortitle="City"/>
                                    </div>
                                    <div class="small-12 medium-6 large-6 columns" data-bignamevalidateid="shipping_stateProvinceGeoId">
                                        <label class="bigNameSelect" data-bigNameValidateParent="shipping_stateProvinceGeoId">
                                ...
                                <div class="row">
                                    <div class="small-12 medium-12 large-12 columns" data-bignamevalidateid="shipping_countryGeoId">
                                        <label class="bigNameSelect" data-bigNameValidateParent="shipping_countryGeoId">
                ...
                <div class="padding-xs margin-top-xs address-input generic-container coBillingAddress jqs-tracking jqs-opt1" data-tracking-seq="5" data-tracking-name="Billing Address">
                    <div class="jqs-billing">
                        ...
                        <div class="billing-content">
                            ...
                            <div class="row">
                                <div class="small-12 medium-6 large-6 columns" data-bignamevalidateid="billing_firstName">
                                    <input class="jqs-first-name" name="billing_firstName" type="text" placeholder="First Name" data-bignamevalidate="billing_firstName" data-bignamevalidatetype="required" data-bignamevalidateerrortitle="First Name"/>
                                </div>
                                <div class="small-12 medium-6 large-6 columns" data-bignamevalidateid="billing_lastName">
                                    <input class="jqs-last-name" name="billing_lastName" type="text" placeholder="Last Name" data-bignamevalidate="billing_lastName" data-bignamevalidatetype="required" data-bignamevalidateerrortitle="Last Name"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="small-12 medium-12 large-12 columns">
                                    <input class="jqs-company-name" name="billing_companyName" type="text" placeholder="Company (Optional)" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="small-12 medium-12 large-12 columns" data-bignamevalidateid="billing_address1">
                                    <input class="jqs-address1" name="billing_address1" type="text" placeholder="Address Line 1" data-bignamevalidate="billing_address1" data-bignamevalidatetype="required" data-bignamevalidateerrortitle="Address"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="small-12 medium-12 large-12 columns">
                                    <input class="jqs-address2" name="billing_address2" type="text" placeholder="Address Line 2 (Optional)" />
                                </div>
                            </div>
                        <#--<div class="row">
                            <div class="small-12 medium-12 large-12 columns">
                            ...
                            <div class="row">
                                <div class="small-12 medium-3 large-3 columns" data-bignamevalidateid="billing_city">
                                    <input class="jqs-city" name="billing_city" type="text" placeholder="City" data-bignamevalidate="billing_city" data-bignamevalidatetype="required" data-bignamevalidateerrortitle="City"/>
                                </div>
                                <div class="small-12 medium-6 large-6 columns" data-bignamevalidateid="billingState">
                                    <label class="bigNameSelect" data-bigNameValidateParent="billing_stateProvinceGeoId">
                                        <select class="jqs-state" name="billing_stateProvinceGeoId" data-type="billing" data-bignamevalidate="billing_stateProvinceGeoId" data-bignamevalidatetype="required state" data-bignamevalidateerrortitle="State">
                                            <option value="">State/Province</option>
                                        ${screens.render("component://envelopes/widget/CommonScreens.xml#states")}
                                        </select>
                                    </label>
                                ...
                                <div class="small-12 medium-3 large-3 columns" data-bignamevalidateid="billing_postalCode">
                                    <input class="jqs-postal-code" name="billing_postalCode" data-type="billing" type="text" value="${parameterMap.billing_postalCode?default('')}" placeholder="Zip" data-bignamevalidate="billing_postalCode" data-bignamevalidatetype="required postalCode" data-bignamevalidateerrortitle="Zip"/>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="small-12 medium-12 large-12 columns" data-bignamevalidateid="billing_contactNumber">
                                    <input class="jqs-phone" name="billing_contactNumber" type="text" placeholder="Phone" data-bignamevalidate="billing_contactNumber" data-bignamevalidatetype="required" data-bignamevalidateerrortitle="Phone"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="small-12 medium-12 large-12 columns">
                                <input class="jqs-resellerid" name="resellerId" type="text" value="${parameterMap.resellerId?default('')}" maxlength="20" placeholder="Tax ID (Optional)" autocomplete="off" />
                    ...
                    <div>
                        ...
                        <div class="row padding-left-xs margin-top-xxs">
                                ...
                                <div class="col-xs-12 margin-top-xxs">
                                    <div class="row margin-left-xxs margin-right-xxs">
                                        ...
                                        <div class="small-12 medium-6 large-6 columns" data-bignamevalidateid="cardNumber">
                                            <input class="jqs-card-number inspectletIgnore" name="cardNumber" type="text" value="${parameterMap.cardNumber?default('')}" placeholder="Card Number" data-bignamevalidate="cardNumber" data-bignamevalidatetype="required creditCard" data-bignamevalidateerrortitle="Card Number"/>
                                        </div>
                                        <div class="small-12 medium-3 large-3 columns" data-bignamevalidateid="expMonth">
                                            <label class="bigNameSelect" data-bigNameValidateParent="expMonth">
                                        ...
                                        <div class="small-12 medium-3 large-3 columns" data-bignamevalidateid="expYear">
                                            <label class="bigNameSelect" data-bigNameValidateParent="expYear">
                            ...
                            <div id="jqs-pay-by-check" class="row pay-by-check">
                                <div class="row">
                                    <div class="small-12 medium-6 large-6 columns no-padding padding-left-sm margin-top-xxs">
                            ...
                            <div id="jqs-pay-by-amazon" class="row pay-by-amazon">
                                <input type="hidden" name="externalId" class="jqs-amazon-external-id" value="" data-bignamevalidate="externalId" data-bignamevalidatetype="required" data-bignamevalidateerrormessage="Please click the below 'Pay with Amazon' button to login to your Amazon account." />
